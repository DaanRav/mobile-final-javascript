document.addEventListener("DOMContentLoaded", function() {
    ...
    function goForward() {
        ...
        if (activeIndex < 2) {  
            ...
            currentGroup.dataset.status = "after-mobile";
            nextGroup.dataset.status = "becoming-active-mobile";

            setTimeout(() => {
                nextGroup.dataset.status = "active-mobile";
    ...
    function goBack() {
        ...
        if (activeIndex > 0) {  
            ...
            currentGroup.dataset.status = "before-mobile";
            prevGroup.dataset.status = "becoming-active-from-before-mobile";

            setTimeout(() => {
                prevGroup.dataset.status = "active-mobile";
